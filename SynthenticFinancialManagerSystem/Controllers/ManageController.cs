...
using SynthenticFinancialManagerSystem.Models.ManageViewModels;
using SynthenticFinancialManagerSystem.Services;

namespace SynthenticFinancialManagerSystem.Controllers
{
    [Authorize]
    ...
    public class ManageController : Controller
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("SynthenticFinancialManagerSystem"),
